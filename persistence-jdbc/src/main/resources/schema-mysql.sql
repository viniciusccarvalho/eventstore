...
CREATE UNIQUE INDEX IX_Commits ON COMMITS (BUCKET_ID, STREAM_ID, COMMIT_SEQUENCE);
CREATE UNIQUE INDEX IX_Commits_CommitId ON COMMITS (BUCKET_ID, STREAM_ID, COMMIT_ID);
CREATE UNIQUE INDEX IX_Commits_Revisions ON COMMITS (BUCKET_ID, STREAM_ID, STREAM_REVISION, ITEMS);
CREATE INDEX IX_Commits_Dispatched ON COMMITS (DISPATCHED);
CREATE INDEX IX_Commits_Stamp ON COMMITS (COMMIT_STAMP);
